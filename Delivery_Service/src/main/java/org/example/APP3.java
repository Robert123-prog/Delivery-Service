...
public class APP3{
    ...
    /**
     * Constructs a new org.example.APP3 instance with the specified controller.
     *
    ...
    private static IRepository<Order> createInMemoryOrderRepository() {
        ...
        orderIRepository.create(new Order(1, 1, java.sql.Date.valueOf("2024-06-06"), LocalDateTime.of(2024, 6, 10, 12, 0)));//, 150.75, "Processing"));
        orderIRepository.create(new Order(2, 2, java.sql.Date.valueOf("2024-06-07"), LocalDateTime.of(2024, 6, 12, 14, 30)));//, 200.50, "Shipped"));
